...
const APP_URL = 'https://nutritrack-br.vercel.app';
    ...
    <AppLayout title="Configurações">
      <div className="space-y-8 pb-8">
        ...
        <section className="space-y-3">
          ...
          {installed ? (
            <div className="flex items-center gap-2 border border-primary/40 bg-primary/10 p-3 text-sm font-body text-primary">
            ...
            <div className="border border-muted-foreground/30 p-3 space-y-2">
        ...
        {/* Acesso admin — só pro administrador (e-mail do Weslley / papel admin) */}
        {isAdmin && (
          <section className="space-y-3">
            <h2 className="text-base flex items-center gap-2">
            ...
            >
              <div>
                <p className="font-heading text-sm uppercase tracking-widest text-primary">Acesso admin</p>
                <p className="text-xs text-muted-foreground font-body mt-0.5">Painel de usuários, planos e relatórios</p>
              </div>
        ...
        <section className="space-y-3">
          <h2 className="text-base flex items-center gap-2">
            <Share2 className="h-4 w-4 text-primary" /> Compartilhar App
          </h2>
